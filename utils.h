...
extern int pread_pwrite_copy(int in_fd, int out_fd, off_t in_offset, off_t out_offset, size_t nbytes, void *buf);
//general utilities
...
extern char * get_time_string_realtime(struct timespec t0,struct timespec t1);
